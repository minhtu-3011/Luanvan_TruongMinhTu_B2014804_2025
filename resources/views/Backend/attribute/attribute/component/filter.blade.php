    ...
    <div class="uk-flex uk-flex-middle uk-flex-space-between">
        ...
        <div class="action">
            <div class="uk-flex uk-flex-middle">
                ...
                <select name="attribute_catalogue_id" class="form-control select2 ml10">
                ...
                <a href="{{route('attribute.create')}}" class="btn btn-danger"><i class="fa fa-plus">{{__('messages.attribute.create.title')}}</i></a>
            </div>

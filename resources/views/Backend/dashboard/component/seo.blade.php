                        ...
                        <div class="seo-wrapper">
                            <div class="row mb10">
                                <div class="col-lg-12">
                                    ...
                                    <input type="text" {{(isset($disabled)) ? 'disabled' : ''}} name="meta_title"  value="{{ old('meta_title', $model->meta_title ?? '') }}"  class="form-control" placeholder=""
                                        autocomplete="off" id="">
                                </div>
                                </div>
                            </div>
                            <div class="row mb10">
                                <div class="col-lg-12">
                                    ...
                                    <input type="text" {{(isset($disabled)) ? 'disabled' : ''}} name="meta_keyword"  value="{{ old('meta_keyword', $model->meta_keyword ?? '') }}"  class="form-control" placeholder=""
                                        autocomplete="off" id="">
                                </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb10">
                                <div class="col-lg-12">
                                    ...
                                    <textarea type="text" {{(isset($disabled)) ? 'disabled' : ''}} name="meta_description"  value=""  class="form-control" placeholder=""
                            ...
                            <div class="row mb10">
                                <div class="col-lg-12">
                                    ...
                                    <div class="input-wrapper">
                                        <input type="text" {{(isset($disabled)) ? 'disabled' : ''}} name="canonical"  value="{{ old('canonical', $model->canonical ?? '') }}"  class="form-control" placeholder=""
                                        autocomplete="off" id="">

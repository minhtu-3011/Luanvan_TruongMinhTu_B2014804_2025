                        ...
                        <div class="row mb10">
                            <div class="col-lg-12">
                                <div class="form-row">
                                    ...
                                    <textarea type="text" name="content"  value=""  class="form-control ck-editor" placeholder=""
                                        autocomplete="off" id="content" data-height="500px">{{ old('content', $postCatalogue->content ?? '') }} </textarea>
                                </div>
                            </div>
                        </div>
<div class="ibox">
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="canonical">
                            {{ old('canonical', $post->canonical ?? 'https://duong-dan-cua-ban.html') 
                        ...
                        <div class="seo-wrapper">
                            <div class="row mb10">
                                <div class="col-lg-12">
                                    ...
                                    <input type="text" name="meta_title"  value="{{ old('meta_title', $post->meta_title ?? '') }}"  class="form-control" placeholder=""
                                        autocomplete="off" id="">
                                </div>
                                </div>
                            </div>
                            <div class="row mb10">
                                <div class="col-lg-12">
                                    ...
                                    <input type="text" name="meta_keyword"  value="{{ old('meta_keyword', $post->meta_keyword ?? '') }}"  class="form-control" placeholder=""
                                        autocomplete="off" id="">
                                </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb10">
                                <div class="col-lg-12">
                                    ...
                                    <textarea type="text" name="meta_description"  value=""  class="form-control" placeholder=""
                                        autocomplete="off" id="">{{ old('meta_description', $post->meta_description ?? '') }} </textarea>
                                </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb10">
                                <div class="col-lg-12">
                                    ...
                                    <div class="input-wrapper">
                                        <input type="text" name="canonical"  value="{{ old('canonical', $post->canonical ?? '') }}"  class="form-control" placeholder=""
                                        autocomplete="off" id="">

<div class="ibox variant-box">
    <div class="ibox-title">
        ...
        Cho phép bạn bán các phiên bản khác nhau của sản phẩm, ví dụ: quần, áo thì có các 
        <strong class="text-danger">màu sắc</strong> và 
        <strong class="text-danger">size</strong> số khác nhau. 
        Mỗi phiên bản sẽ là 1 dòng trong mục danh sách phiên bản phía dưới
        </div>
    </div>
    ...
    <div class="ibox-content">
            ...
            <div class="col-lg-12">
                <div class="variant-checkbox uk-flex uk-flex-middle">
                    ...
                    <label for="variantCheckbox" class="turnOnVariant">
                        Sản phẩm này có nhiều biến thể. Ví dụ như khác nhau về màu sắc, kích thước
                    </label>
                </div>
            </div>
        </div>
        ...
        @php
            $variantCatalogue = old(
                'attributeCatalogue',
                (isset($product->attributeCatalogue)
        ...
        <div class="variant-body">
            ...
            <div class="row mb20 variant-item">
                ...
                <div class="col-lg-8">
                    ...
                    multiple data-catid="{{ $valAttr }}" id=""></select>

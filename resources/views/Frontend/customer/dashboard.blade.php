...
@php
    // dd($customer);
@endphp
<form action="{{route('customer.feupdate')}}" method="post" class="box">
    @csrf
    <div class="infor-customer wrapper wrapper-content animated fadeInRight">
                        ...
                        <div class="row mb15">
                            <div class="col-lg-6">
                                <div class="form-row customerWrapper">
                                    ...
                                    <select name="customer_catalogue_id" class="form-control select2">
        ...
        <div class="text-right mb15">
            <button style="margin-right: 50px" class="btn btn-primary" type="submit" name="send" value="send">Lưu lại</button>
        </div>
    </div>
</form>
